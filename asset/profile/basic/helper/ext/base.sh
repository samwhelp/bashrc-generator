...
base_var_init () {
	...
	THE_BASHRC_FILE_NAME=".bashrc"

	#THE_BASHRC_BUILD_TARGET_DIR_PATH="${THE_MASTER_DIR_PATH}"
	THE_BASHRC_BUILD_TARGET_DIR_PATH="${THE_MASTER_ASSET_OVERLAY_DIR_PATH}/etc/skel"

	THE_BASHRC_BUILD_TARGET_FILE_NAME="${THE_BASHRC_FILE_NAME}"
	THE_BASHRC_BUILD_TARGET_FILE_PATH="${THE_BASHRC_BUILD_TARGET_DIR_PATH}/${THE_BASHRC_BUILD_TARGET_FILE_NAME}"

	THE_BASHRC_INSTALL_TARGET_FILE_NAME="${THE_BASHRC_FILE_NAME}"
	THE_BASHRC_INSTALL_TARGET_FILE_PATH="${HOME}/${THE_BASHRC_INSTALL_TARGET_FILE_NAME}"
...
base_var_dump () {
	...
	util_debug_echo
	util_debug_echo "##"
	util_debug_echo "## ## Master Path / Bashrc"
	util_debug_echo "##"
	util_debug_echo

	util_debug_echo "THE_BASHRC_FILE_NAME=${THE_BASHRC_FILE_NAME}"
	util_debug_echo

	util_debug_echo "THE_BASHRC_BUILD_TARGET_DIR_PATH=${THE_BASHRC_BUILD_TARGET_DIR_PATH}"
	util_debug_echo

	util_debug_echo "THE_BASHRC_BUILD_TARGET_FILE_NAME=${THE_BASHRC_BUILD_TARGET_FILE_NAME}"
	util_debug_echo "THE_BASHRC_BUILD_TARGET_FILE_PATH=${THE_BASHRC_BUILD_TARGET_FILE_PATH}"
	util_debug_echo

	util_debug_echo "THE_BASHRC_INSTALL_TARGET_FILE_NAME=${THE_BASHRC_INSTALL_TARGET_FILE_NAME}"
	util_debug_echo "THE_BASHRC_INSTALL_TARGET_FILE_PATH=${THE_BASHRC_INSTALL_TARGET_FILE_PATH}"
	util_debug_echo
